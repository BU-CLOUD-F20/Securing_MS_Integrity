...
def main():
  ...
  if args.clean:
    files_to_delete = [
      "Zhou-Owner/root.layout",
      "Dimitris-clone&pytest/clone.776a00e2.link",
      "Dimitris-clone&pytest/pytest.776a00e2.link",
      "Ningrong-package/intro-to-pytest",
      "Ningrong-package/package.2f89b927.link",
      "Ningrong-package/intro-to-pytest.tar.gz",
      # "Dimitris-clone&pytest/intro-to-pytest.tar.gz",
      "Dimitris-clone&pytest/intro-to-pytest",
      "final_product/alice.pub",
      "final_product/intro-to-pytest.tar.gz",
      ...
      "final_product/intro-to-pytest.tar.gz",
      "final_product/pytest.776a00e2.link",
      "final_product/intro-to-pytest"
    ]
